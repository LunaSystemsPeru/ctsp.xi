...
<head>
    ...
    <meta property="og:description" content="Partida Registral del Colegio de Trabajadores Sociales del Peru - Region XI Ancash" />
    ...
    <!-- PAGE TITLE HERE -->
    <title>Partida Registral | Colegio de Trabajadores Sociales del Peru - Region XI Ancash</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center section-head">
                        <h3 class="h3"> Partida Registral Nro 11085805</h3>
                ...
                <div class="section-content ">
                    <div class="row">
                        <div class="col-lg-12">
                            <embed src="archivos/PartidaRegistral.pdf" width="100%" height="1000px">
                        </div>
                    </div>
                </div>
