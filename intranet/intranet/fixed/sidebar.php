<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="ai-icon" href="../public/index.php" aria-expanded="false">
            ...
            <li><a class="ai-icon" href="ver_caja_dia.php" aria-expanded="false">
            ...
            <li><a class="ai-icon" href="ver_bancos.php" aria-expanded="false">
                    ...
                    <span class="nav-text">Caja - Bancos</span>
                </a>
            </li>
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="ver_asociados_pendientes.php">Solicitudes Inscripcion</a></li>
                    <li><a href="ver_asociados.php">Lista Asociados</a></li>
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="ver_archivos.php">Archivos</a></li>
                    <li><a href="ver_formatos.php">Formato Certificados</a></li>
                    <li><a href="ver_parametros.php">Parametros Generales</a></li>
