...
<head>
    ...
    <meta property="og:description" content="Acceso a la Intranet del Colegio de Trabajadores Sociales del Peru - Region XI Ancash"/>
                            ...
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="pricingtable-wrapper">
                                    <div class="pricingtable-inner pricingtable-highlight">
                                        ...
                                        <ul class="pricingtable-features">
                                            <li><i class="fa fa-check"></i> Padron Colegiados</li>
                                            <li><i class="fa fa-check"></i> Inscripciones de Colegiados</li>
                                            <li><i class="fa fa-check"></i> Registro de Cursos y Asistentes</li>
                            ...
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="pricingtable-wrapper">
                                    <div class="pricingtable-inner">
                                        ...
                                        <ul class="pricingtable-features">
                                            <li><i class="fa fa-check"></i> Ver Perfil</li>
                                            <li><i class="fa fa-check"></i> Ver Cronograma de Pagos</li>
                                            <li><i class="fa fa-check"></i> Constancia de Habilidad</li>
                                            <li><i class="fa fa-check"></i> Ver Bolsa Laboral</li>
                                            <li><i class="fa fa-check"></i> Reporte de Deudas</li>
                                        </ul>
                                        <div class="pricingtable-footer"><a href="intranet/colegiado/contents/login.php" class="site-button radius-no">Ingresar</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
