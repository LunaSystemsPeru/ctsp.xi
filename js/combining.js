...
var MediCo = function () {
    ...
    return {
        init: function () {
            ...
            }(), n = $(".header").height(), $(".header").css("height", n), function () {
                "use strict";
            ...
            }(), jQuery('iframe[src*="youtube.com"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'), jQuery('iframe[src*="vimeo.com"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'), function (e) {
            ...
            }), $(".full-height").css("height", $(window).height()), jQuery("body").append('<a href="https://1.envato.market/XEnLy" target="_blank" class="bt-buy-now theme-btn"><i class="ti-shopping-cart"></i><span>Buy Now</span></a><a href="https://w3itexperts.ticksy.com" target="_blank" class="bt-support-now theme-btn"><i class="ti-headphone-alt"></i><span>Support</span></a>\x3c!-- Go to www.addthis.com/dashboard to customize your tools --\x3e<script type="text/javascript" src="../../s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b221c5e31b4e54b"><\/script>'), jQuery(window).on("resize", function () {
