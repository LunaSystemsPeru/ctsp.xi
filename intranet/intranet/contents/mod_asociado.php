...
$foto = '../../public/images/profile/pic1.jpg';
if ($asociado->getFoto()) {
    $foto = '../../../images/asociados/perfil/' . $asociado->getFoto();
}
?>
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form METHOD="post" action="../controller/asociado.php" enctype="multipart/form-data">
                                    <input type="hidden" value="<?php echo $asociado->getIdAsociado()?>" name="hidden_asociado">
                                    <div class="form-row">
                                        <div class="form-group col-md-2">
                                            ...
                                            <select class="form-control" name="select_tipo_documento">
                                                ...
                                                foreach ($adocumentos as $fila) {
                                                    $selected = "";
                                                    if ($asociado->getTipoDocumento() == $fila['id_detalle']) {
                                                        $selected= "selected";
                                                    }
                                                    echo "<option ". $selected ." value='".$fila['id_detalle']."'>".$fila['nombre']."</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select class="form-control" name="select_tipo_inscripcion">
                                                ...
                                                foreach ($ainscripcion as $fila) {
                                                    $selected = "";
                                                    if ($asociado->getTipoRegistro() == $fila['id_detalle']) {
                                                        $selected= "selected";
                                                    }
                                                    echo "<option ".$selected." value='".$fila['id_detalle']."'>".$fila['nombre']."</option>";
                                                }
                                        ...
                                        <div class="form-group col-md-5">
                                            <label>Email</label>
                                            <input type="email" class="form-control" placeholder="correo@correo.com" name="input_email" value="<?php echo $asociado->getEmail() ?>" required>
                                        </div>
                                        <div class="form-group col-md-3">
                                    ...
                                    <div class="form-row">
                                        <div class="col-lg-4" >
                                            <div id="preview">
                                                <img src="<?php echo $foto?>" class="col-lg-12" id="img_perfil">
                                            </div>
